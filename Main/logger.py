...
class Logger(object):
    ...
    def __init__(self, filename='data.csv'):
        ...
        self.sistema = Sistema(key=key,citykey="currentcityKey.txt",cityname="currentcityName.txt",timesremain=50,HumidityMin=40,HumidityMax=60,PrecipitationFile="PrecipitationMax.txt")
